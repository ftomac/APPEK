...
<body>
    ...
    <div class="navbar">
		<ul>
			<li class="naslovna" runat="server"><a href="index.aspx"> Naslovna </a></li>
                                ...
                                <ContentTemplate>
                                    <asp:Panel ID="Panel2" runat="server">
                                        <asp:Panel ID="pano" runat="server" CssClass="dashboard">
                                            ...
                                            <div class="calendar">
                                                <asp:Calendar ID="kalendar" runat="server" 
                                                              OnSelectionChanged="kalendar_SelectionChanged" 
                                                              BorderWidth="1px"
                                                              ForeColor="#663399" 
                                                    ...
                                                    <br />
                                                <asp:TextBox ID="txtObavDatum" runat="server" TextMode="MultiLine"  Rows="5"></asp:TextBox>
                                            </div>
                                        </asp:Panel>
                                            <br />
                                            <br />
