                                ...
                                <asp:Panel ID="Panel2" runat="server">
                                    ...
                                    <asp:Panel ID="Unos" runat="server">
                                        <div class="objava">
                                            ...
                                            <asp:Button ID="btnUzmi" runat="server" Text="Uzmi" OnClick="btnUzmi_Click"/>
                                                <br />
                                    ...
                                    <asp:panel ID="skladistePano" runat="server" Visible="false">
            	                        ...
            	                        <asp:Label ID="kolicine" runat="server" Text="Unesite količinu kemikalije za prijenos iz skladišta: "></asp:Label>
